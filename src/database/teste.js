...
Database.then(async(db) => {
    await saveOrphanage(db, {
        ...
        about: "Presta assistência a meninas de 0 a 12 anos que se encontre em situação de risco e/ou vulnerabilidade social",
        ...
        opening_hours: "Horário de visitas Das 9 até 11h",
        open_on_weekends: "1",
    });
